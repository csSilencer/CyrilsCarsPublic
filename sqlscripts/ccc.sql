...
CREATE TABLE CAR_FEATURE (
  ...
  FEATURE_ID_4 NUMBER(7),
  FEATURE_ID_5 NUMBER(7),
  FEATURE_ID_6 NUMBER(7),
  FEATURE_ID_7 NUMBER(7),
  FEATURE_ID_8 NUMBER(7),
  FEATURE_ID_9 NUMBER(7),
  FEATURE_ID_10 NUMBER(7),
...
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_4_FK FOREIGN KEY (FEATURE_ID_4) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_5_FK FOREIGN KEY (FEATURE_ID_5) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_6_FK FOREIGN KEY (FEATURE_ID_6) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_7_FK FOREIGN KEY (FEATURE_ID_7) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_8_FK FOREIGN KEY (FEATURE_ID_8) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_9_FK FOREIGN KEY (FEATURE_ID_9) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
ALTER TABLE CAR_FEATURE ADD CONSTRAINT CAR_FEATURE_ID_10_FK FOREIGN KEY (FEATURE_ID_10) REFERENCES FEATURE (FEATURE_ID) ON DELETE CASCADE;
